...
import { Search, CheckCircle, X, ExternalLink, TrendingUp } from 'lucide-react';
    ...
    <section id="schools" className="py-20 bg-slate-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 scroll-animate">
          ...
          <p className="text-gray-500">收录深圳103所普通高中2025年录取分数线，数据已换算为630分制</p>
        </div>
                ...
                {filtered.map((school, idx) => (
                  <tr key={school.id} className="hover:bg-indigo-50/50 transition-colors duration-150">
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="font-medium text-sm text-gray-900 flex items-center gap-1 mt-0.5">
